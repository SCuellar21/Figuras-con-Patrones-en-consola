========================================================================
    APLICACIÓN DE CONSOLA: Figuras con Patrones en consola Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Figuras con Patrones en consola.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Figuras con Patrones en consola.


Figuras con Patrones en consola.vcxproj
...
Figuras con Patrones en consola.vcxproj.filters
...
Figuras con Patrones en consola.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Figuras con Patrones en consola.pch y un archivo de tipos precompilados llamado StdAfx.obj.
